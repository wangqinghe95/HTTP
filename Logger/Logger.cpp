...
{
    public:
        T(const char* str, unsigned len):m_str(str)
                                        ,m_len(len)
        {
...
{
    int64_t microSecondsSinceEpoch = m_time.mincroSecondSinceEpoch();
    time_t seconds = static_cast<time_t>(microSecondsSinceEpoch / TimeStamp::kMicroSecondPerSecond);
